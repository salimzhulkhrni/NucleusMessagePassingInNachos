...
#define SC_Add		42
#define SC_Fork_POS 50
#define SC_Wait_POS 51

#define SC_Send_Message 52
#define SC_Wait_Message 53
#define SC_Send_Answer 54
#define SC_Wait_Answer 55
...
int Fork_POS(int value);

void Wait_POS(int value);
...
int Send_Message(char* s1,char* s2,int value);

int Wait_Message(char* s1, char* s2, int value);

void Send_Answer(int* s1, char* s2, int value);

void Wait_Answer(int* s1, char* s2, int value);
