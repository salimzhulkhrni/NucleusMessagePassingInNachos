...
class Thread {
  ...
  public:
    ...
    int isWaitingForMessage;
    int isWaitingForAnswer;

    string thread_waiting_message = "";
    string thread_waiting_answer = "";

    //ThreadMessageBuffer * buff;//= new ThreadMessageBuffer();
    
    List<ThreadMessageBuffer*> *threadBufferPool = new List<ThreadMessageBuffer*>();  // buffer list to receive messages
    List<ThreadMessageBuffer*> *answerBufferPool = new List<ThreadMessageBuffer*>();  // buffer list to receive answers

    map<string,ThreadMessageBuffer*> thread_to_buffer_map;
    int msgCounter = 0;

    int answer_result = 0;
    char* kernel_message = NULL;
