...
Timer::Timer(bool doRandom, CallBackObj *toCall,int quantum)
{
    ...
    if(quantum < 1000){
      ...
      this->quantum = 1000;
      cout<<"IN: TIMER CLASS: Quantum Is Too Small. Taking the default quantum value: "<<this->quantum<<endl;
    }
      
    else{

      this->quantum=quantum;
      cout<<"IN: TIMER CLASS: Quantum: "<<this->quantum<<endl;
...
Timer::SetInterrupt() 
{
     if (!disable) {
       ...
       //cout<<"Inside TIMER INTERRUPT: "<<this->quantum<<endl;
       if (randomize) {
       delay = 1 + (RandomNumber() % (this->quantum * 2));
        }
